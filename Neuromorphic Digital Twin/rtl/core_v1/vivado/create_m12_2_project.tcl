# M12.2 physical implementation: K26 PS clock + VIO/JTAG host-stepped trace shell.
if {$argc != 17} {
    error "usage: create_m12_2_project.tcl <ip_repo_dir> <project_dir> <target_part> <expected_vlnv> <decoder_rtl> <phase_b_rtl> <neuron_rtl> <integrated_rtl> <route_rtl> <recurrent_rtl> <bridge_rtl> <capture_rtl> <capture_bd_rtl> <capture_vectors> <report_dir> <artifact_dir> <jobs>"
}
...
set project_name "neuromorphic_twin_m12_2"
set bd_name "neuromorphic_twin_m12_2"
set capture_module "m12_2_single_tick_capture_controller_bd_v1"
...
foreach path [list $ip_repo_dir $decoder_rtl $phase_b_rtl $neuron_rtl $integrated_rtl $route_rtl $recurrent_rtl $bridge_rtl $capture_rtl $capture_bd_rtl $capture_vectors] {
    if {![file exists $path]} {
        error "Required M12.2 input does not exist: $path"
    }
}
...
proc connect_verified_pair {capture_pin hls_pin} {
    ...
    if {[llength $cp] != 1 || [llength $hp] != 1} {
        error "Missing M12.2 integration pin: capture=$capture_pin ($cp), hls=$hls_pin ($hp)"
    }
    ...
    if {[llength $cn] != 1 || [llength $hn] != 1 || [lindex $cn 0] ne [lindex $hn 0]} {
        error "M12.2 integration pin connectivity mismatch: capture=$capture_pin nets=$cn, hls=$hls_pin nets=$hn"
    }
}
...
proc connect_named_pair {net_name left_pin right_pin} {
    ...
    if {[llength $lp] != 1 || [llength $rp] != 1} {
        error "Missing M12.2 VIO connection pin for $net_name: left=$lp right=$rp"
    }
...
if {[llength $kv260_board_parts] == 0} {
    error "M12.2 requires the Vivado KV260 SOM board files (xilinx.com:kv260_som:part0:*)."
}
...
puts "M12.2 K26 SOM board preset: $kv260_board_part"
...
if {[llength $pl_clk0_pin] != 1} {
    error "M12.2 KV260 PS preset did not expose the required pl_clk0 fabric clock."
}
...
set local_reset [create_bd_cell -type ip -vlnv xilinx.com:ip:proc_sys_reset:5.0 proc_sys_reset_m12_2]
set const_one [create_bd_cell -type ip -vlnv xilinx.com:ip:xlconstant:1.1 const_one_m12_2]
set_property -dict [list CONFIG.CONST_WIDTH {1} CONFIG.CONST_VAL {1}] $const_one
set const_zero [create_bd_cell -type ip -vlnv xilinx.com:ip:xlconstant:1.1 const_zero_m12_2]
...
connect_bd_net [get_bd_pins zynq_ultra_ps_e_0/pl_clk0] \
    ...
    [get_bd_pins vio_m12_2/clk] \
    [get_bd_pins proc_sys_reset_m12_2/slowest_sync_clk]
connect_named_pair capture_resetn vio_m12_2/probe_out5 proc_sys_reset_m12_2/ext_reset_in
connect_bd_net [get_bd_pins const_one_m12_2/dout] \
    [get_bd_pins proc_sys_reset_m12_2/dcm_locked] \
    [get_bd_pins proc_sys_reset_m12_2/aux_reset_in]
connect_bd_net [get_bd_pins const_zero_m12_2/dout] \
    [get_bd_pins proc_sys_reset_m12_2/mb_debug_sys_rst]
set reset_released_net [create_bd_net reset_released]
connect_bd_net -net $reset_released_net \
    [get_bd_pins proc_sys_reset_m12_2/peripheral_aresetn] \
    [get_bd_pins capture_0/capture_resetn] \
    [get_bd_pins vio_m12_2/probe_in2]
connect_bd_net [get_bd_pins proc_sys_reset_m12_2/peripheral_reset] \
...
# Named nets form the stable Hardware Manager API used by capture_m12_2_single_tick.tcl.
connect_named_pair clock_heartbeat                    capture_0/clock_heartbeat vio_m12_2/probe_in0
connect_named_pair start_seen                         capture_0/start_seen vio_m12_2/probe_in1
connect_named_pair capture_busy                       capture_0/capture_busy vio_m12_2/probe_in3
connect_named_pair step_ready                         capture_0/step_ready vio_m12_2/probe_in4
connect_named_pair trace_window_open                  capture_0/trace_window_open vio_m12_2/probe_in5
connect_named_pair capture_done                       capture_0/capture_done vio_m12_2/probe_in6
connect_named_pair capture_fault                      capture_0/capture_fault vio_m12_2/probe_in7
connect_named_pair capture_fault_code                 capture_0/capture_fault_code vio_m12_2/probe_in8
connect_named_pair capture_phase                      capture_0/capture_phase vio_m12_2/probe_in9
connect_named_pair observed_tick                      capture_0/observed_tick vio_m12_2/probe_in10
connect_named_pair observed_core_fault                capture_0/observed_core_fault vio_m12_2/probe_in11
connect_named_pair observed_core_fault_code           capture_0/observed_core_fault_code vio_m12_2/probe_in12
connect_named_pair observed_recurrent_bank            capture_0/observed_recurrent_bank vio_m12_2/probe_in13
connect_named_pair observed_recurrent_count           capture_0/observed_recurrent_count vio_m12_2/probe_in14
connect_named_pair observed_recurrent_bank0_count     capture_0/observed_recurrent_bank0_count vio_m12_2/probe_in15
connect_named_pair observed_recurrent_bank1_count     capture_0/observed_recurrent_bank1_count vio_m12_2/probe_in16
connect_named_pair observed_consumed_recurrent_count  capture_0/observed_consumed_recurrent_count vio_m12_2/probe_in17
connect_named_pair observed_routed_recurrent_count    capture_0/observed_routed_recurrent_count vio_m12_2/probe_in18
connect_named_pair observed_external_event_count      capture_0/observed_external_event_count vio_m12_2/probe_in19
connect_named_pair trace_read_ready                   capture_0/trace_read_ready vio_m12_2/probe_in20
connect_named_pair trace_response_seq                 capture_0/trace_response_seq vio_m12_2/probe_in21
connect_named_pair trace_response_space               capture_0/trace_response_space vio_m12_2/probe_in22
connect_named_pair trace_response_addr                capture_0/trace_response_addr vio_m12_2/probe_in23
connect_named_pair trace_response_data                capture_0/trace_response_data vio_m12_2/probe_in24
...
connect_named_pair trace_read_req                     vio_m12_2/probe_out2 capture_0/trace_read_req
connect_named_pair trace_read_space                   vio_m12_2/probe_out3 capture_0/trace_read_space
connect_named_pair trace_read_addr                    vio_m12_2/probe_out4 capture_0/trace_read_addr

validate_bd_design
save_bd_design
puts "M12.2 physical trace-capture block design validated successfully."

set bd_files [get_files -quiet */${bd_name}.bd]
if {[llength $bd_files] != 1} {
    error "Expected exactly one M12.2 block-design file, found: $bd_files"
}
set bd_file [lindex $bd_files 0]
generate_target all $bd_file
set wrapper_files [make_wrapper -files $bd_file -top]
if {[llength $wrapper_files] == 0} {
    error "Vivado did not generate an HDL wrapper for M12.2"
}
...
puts ""
puts "=== M12.2 synthesis ==="
launch_runs synth_1 -jobs $jobs
wait_on_run synth_1
set synth_status [get_property STATUS [get_runs synth_1]]
puts "M12.2 synth_1 status: $synth_status"
if {[string first "Complete" $synth_status] < 0} {
    error "M12.2 synthesis did not complete successfully: $synth_status"
}

puts ""
puts "=== M12.2 implementation + bitstream ==="
launch_runs impl_1 -to_step write_bitstream -jobs $jobs
wait_on_run impl_1
set impl_status [get_property STATUS [get_runs impl_1]]
puts "M12.2 impl_1 status: $impl_status"
if {[string first "Complete" $impl_status] < 0} {
    error "M12.2 implementation/bitstream did not complete successfully: $impl_status"
}
open_run impl_1
puts "M12.2 implementation completed successfully."
...
write_checkpoint -force [file join $artifact_dir neuromorphic_twin_m12_2_routed.dcp]
write_debug_probes -force [file join $artifact_dir neuromorphic_twin_m12_2.ltx]
...
if {[llength $worst_setup] != 1 || [llength $worst_hold] != 1} {
    error "M12.2 could not obtain routed setup/hold timing paths."
}
set wns [get_property SLACK [lindex $worst_setup 0]]
set whs [get_property SLACK [lindex $worst_hold 0]]
puts "M12.2 routed worst setup slack: $wns ns"
puts "M12.2 routed worst hold slack: $whs ns"
if {$wns < 0.0 || $whs < 0.0} {
    error "M12.2 routed timing failed: WNS=$wns ns WHS=$whs ns"
}
puts "M12.2 routed timing check passed: WNS=$wns ns, WHS=$whs ns"

set drc_errors [get_drc_violations -quiet -filter {SEVERITY == Error}]
if {[llength $drc_errors] != 0} {
    error "M12.2 implemented design has DRC errors: $drc_errors"
}

set impl_dir [get_property DIRECTORY [get_runs impl_1]]
set bit_files [glob -nocomplain -directory $impl_dir *.bit]
if {[llength $bit_files] != 1} {
    error "M12.2 expected exactly one generated .bit file in $impl_dir, found: $bit_files"
}
set bit_src [lindex $bit_files 0]
set bit_dst [file join $artifact_dir neuromorphic_twin_m12_2.bit]
file copy -force $bit_src $bit_dst
write_hw_platform -fixed -include_bit -force -file [file join $artifact_dir neuromorphic_twin_m12_2.xsa]

if {![file exists $bit_dst]} {
    error "M12.2 bitstream copy was not created: $bit_dst"
}
puts "M12.2 bitstream generated successfully."
puts "Bitstream: $bit_dst"
puts "Debug probes: [file join $artifact_dir neuromorphic_twin_m12_2.ltx]"
puts "Hardware handoff: [file join $artifact_dir neuromorphic_twin_m12_2.xsa]"
