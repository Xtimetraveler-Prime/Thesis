...
// Verilog-2001 Module Reference boundary for the M12.1.3 capture controller.
module m12_1_capture_controller_bd_v1 (
    ...
    // Free-running witness independent of capture/core reset.
    ...
    // Sticky witness that the VIO start command reached this shell.
    ...
    m12_1_capture_controller_v1 capture_i (
