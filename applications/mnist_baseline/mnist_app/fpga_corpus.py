...
def write_corpus_systemverilog_include(
    ...
    lines = [
        "// Generated by applications/mnist_baseline/scripts/generate_fpga_corpus.py; do not edit.",
        ...
        json.dumps(
            {
                ...
                "source_corpus": "applications/mnist_baseline/frozen/mnist-v1/fpga_validation_corpus.json",
