...
from mnist_app.fpga_corpus import build_corpus_cases, write_corpus_bundle
...
def main() -> int:
    ...
    total_events = sum(
        len(events) for case in cases for events in case.external_schedule
    )
    print(
