...
start = text.index('### M12.2 — Exact single-tick Python-versus-FPGA differential validation')
end = text.index('\n---\n\n### M12.3 — Multi-tick and recurrent-network physical conformance', start)
replacement = '''### M12.2 — Exact single-tick Python-versus-FPGA differential validation
...
'''
milestones.write_text(text[:start] + replacement + text[end:], encoding='utf-8')
