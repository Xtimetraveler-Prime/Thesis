...
# M11 repository evidence now includes the completed M11.5 integration branch.
text = text.replace(
...
old_m115_header = """### M11.5 — Integrate memories, tick control, routing, and observability

**Status:** In progress  
**Started:** 2026-08-24  
**Repository evidence:** `main` through M11.5.4; branch `agent/m11-5-5-system-validation` for M11.5.5
"""
new_m115_header = """### M11.5 — Integrate memories, tick control, routing, and observability
...
**Repository evidence:** `main` through M11.5.5
"""
if old_m115_header not in text:
    raise SystemExit("M11.5 header pattern not found")
text = text.replace(old_m115_header, new_m115_header, 1)

start_marker = "#### M11.5.5 — Integrated observability and Vivado system validation"
end_marker = "\n---\n\n### M11.6 — Generate first integrated bitstream and perform hardware smoke checks"
start = text.index(start_marker)
end = text.index(end_marker, start)

replacement = """#### M11.5.5 — Integrated observability and Vivado system validation
